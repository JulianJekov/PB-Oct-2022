...
public class Problem_02 {
    public static void main(String[] args) {
        ...
        int surprice = Integer.parseInt(scanner.nextLine());

        double sum = love * 0.60 + roses * 7.20 + keyChain * 3.60 + caricatures * 18.20 + surprice * 22;
        int numItems = love + roses + keyChain + caricatures + surprice;
